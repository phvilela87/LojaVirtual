...
public class WebServiceSalesProviderClient {

    private static final String GET_TOKEN = "/token";
    private static final String TAG = "WebServiceSalesProviderClient";
    private static HttpURLConnection conn;
    private static AccessToken accessToken;

    private WebServiceSalesProviderClient() {
    }
    ...
    public static boolean isTokenValid(Context context) {
        ...
        if (sharedSettings.contains(
                context.getString(R.string.pref_ws_sales_provider_access_token)) &&
                sharedSettings.contains(context.getString(
                        R.string.pref_ws_sales_provider_access_token_expiration))) {
            expirationTime = sharedSettings.getLong(context.getString(
                    R.string.pref_ws_sales_provider_access_token_expiration), 0);
    ...
    private static void invalidateToken(Context context) {
        ...
        editor.remove(context.getString(R.string.pref_ws_sales_provider_access_token));
        editor.remove(context.getString(R.string.pref_ws_sales_provider_access_token_expiration));
        editor.commit();
    }
    ...
    private static WebServiceResponse authenticate(Context context) {
        ...
        String baseAddress = WSUtil.getSalesProviderHostAddress(context);
        accessToken = null;
        try {
            ...
            if (conn.getResponseCode() == 200) {
                ...
                editor.putString(context.getString(
                        R.string.pref_ws_sales_provider_access_token),
