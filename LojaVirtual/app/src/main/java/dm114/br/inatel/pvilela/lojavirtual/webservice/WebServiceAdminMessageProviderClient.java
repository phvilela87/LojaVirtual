 ...
 */
public class WebServiceAdminMessageProviderClient {
    private static final String GET_TOKEN = "/api/token";
    private static final String TAG = "WebServiceAdminMessageProviderClient";
    private static HttpURLConnection conn;
    private static AccessToken accessToken;

    private WebServiceAdminMessageProviderClient() {
    }
    ...
    public static boolean isTokenValid(Context context) {
        ...
        if (sharedSettings.contains(
                context.getString(R.string.pref_ws_admin_message_provider_access_token)) &&
                sharedSettings.contains(context.getString(
                        R.string.pref_ws_admin_message_provider_access_token_expiration))) {
            expirationTime = sharedSettings.getLong(context.getString(
                    R.string.pref_ws_admin_message_provider_access_token_expiration), 0);
    ...
    private static void invalidateToken(Context context) {
        ...
        editor.remove(context.getString(R.string.pref_ws_admin_message_provider_access_token));
        editor.remove(context.getString(R.string.pref_ws_admin_message_provider_access_token_expiration));
        editor.commit();
    }
    ...
    private static WebServiceResponse authenticate(Context context) {
        ...
        try {
            ...
            String wsUsername = sharedSettings.getString(
                    context.getString(R.string.pref_ws_admin_username),
                    context.getString(R.string.pref_ws_admin_username));
            String wsPassword = sharedSettings.getString(
                    context.getString(R.string.pref_ws_admin_password),
                    context.getString(R.string.pref_ws_admin_password));
            ...
            if (conn.getResponseCode() == 200) {
                ...
                editor.putString(context.getString(
                        R.string.pref_ws_admin_message_provider_access_token),
